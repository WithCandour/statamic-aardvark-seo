  ...
  <html>
    ...
    <body>
      <div class="sitemap__outer">
        ...
        <p class="smol">Generated by Aardvark SEO v<xsl:value-of select="sitemap:sitemapindex/@aardvark-version" />, a Statamic addon by <a target="_blank" rel="noopener nofollow" href="https://withcandour.co.uk">WithCandour</a></p>
        </xsl:if>
        <xsl:if test="sitemap:urlset">
        <p class="smol">Generated by Aardvark SEO v<xsl:value-of select="sitemap:urlset/@aardvark-version" />, a Statamic addon by <a target="_blank" rel="noopener nofollow" href="https://withcandour.co.uk">WithCandour</a></p>
        </xsl:if >
      </div>
    </body>
  </html>
