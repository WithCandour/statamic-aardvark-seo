  ...
  <html>
    ...
    <body>
      <div class="sitemap__outer">
        ...
        <p class="smol">Generated by Aardvark SEO v2.0.0, a Statamic addon by <a target="_blank" rel="noopener nofollow" href="https://withwithcandour.co.uk">WithCandour</a></p>
      </div>
    </body>
  </html>
  </xsl:template>
