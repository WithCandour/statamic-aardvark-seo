...
class Controller extends StatamicController
{
    ...
    public static function getErrors()
    {
        ...
        if (empty($siteUrl)) {
            $errors[] = [
                'level' => 'bad',
                'message' => 'A site url needs to be set in your <a class="text-white underline" href="/' . CP_ROUTE . '/settings">site settings</a>',
            ];
        } elseif (substr($siteUrl, 0, 1) === '/') {
            $errors[] = [
                'level' => 'bad',
                'message' => 'Your site URL should be a full URL in order to generate absolute links, you may set it in your <a class="text-white underline" href="/' . CP_ROUTE . '/settings">site settings</a>',
            ];
        }
